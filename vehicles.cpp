...
void Vehicles::setPassengerReservation(People& player, int seatNumber) {
        ...
        if ((seatOccupancy.at(seatNumber) == false) && (seatNumber < 18) && (player.credits > 4) && ((seatNumber == 0) || (seatNumber == 1) || (seatNumber == 4) ||
        ...
        else if ((seatOccupancy.at(seatNumber) == false) && (seatNumber < 18) && (player.credits > 2) && (seatNumber == 2) || (seatNumber == 3) || (seatNumber == 9) ||
        ...
        else if ((seatOccupancy.at(seatNumber) == false) && (seatNumber < 18) && (player.credits > 1) && (seatNumber == 5) || (seatNumber == 7) || (seatNumber == 12) ||
          (seatNumber == 14)) {
            seatName.at(seatNumber) = player.name;
            seatOccupancy.at(seatNumber) = true;
        ...
        else if ((seatOccupancy.at(seatNumber) == false) && (seatNumber < 18) && (player.credits > 0) && (seatNumber == 6) || (seatNumber == 13)) {
            seatName.at(seatNumber) = player.name;
            seatOccupancy.at(seatNumber) = true;
        ...
        cout << "Unable to reserve seat. The selected player either didn't have enough credits, or the seat was unavailable." << endl;
    }
}

void Vehicles::setPassengerBySeat(People& player, string carType) {

        if ((player.credits > 4) && (carType == "front") && ((seatOccupancy.at(0) == false)
